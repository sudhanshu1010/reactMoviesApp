...
class MoviesList extends React.Component {
    ...
    render() {
       let data = this.state.data;
        ...
        let filterdData = filteredData.filter((movie) => {
            ...
            <div className="main-container">
                ...
                <div className="movie-table-container">
                    <div className="filters">
                        <input value={this.state.search} placeholder="What's poppin?" className="movie-search" type="text" onChange={this.changeSearch} />
                        <select className="rating-dropdown" name="rating" onChange={this.changeRating}>
                            <option value={"all"} selected>Select Rating</option>
                    ...
                    <Pagination totalMovies={filterdData.length} changePage={this.changePage} />
                </div>
            </div>
        )
    }
